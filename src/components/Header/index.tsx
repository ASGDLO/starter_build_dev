            ...
            <div className="flex w-full items-center justify-between px-4">
                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-dark group-hover:text-primary dark:text-blac dark:group-hover:text-primary lg:inline-flex lg:px-0 lg:py-6 ${
                            ...
                            <Link
                              ...
                              className={`ud-menu-scroll flex py-2 text-base lg:inline-flex lg:px-0 lg:py-6 ${
                                sticky
                                  ? "text-dark group-hover:text-primary dark:text-black dark:group-hover:text-primary"
                                  : "text-body-color dark:text-black lg:text-black"
                              } ${
                        ...
                        <li className="submenu-item group relative" key={index}>
                          {pathUrl !== "/" ? (
                            <button
                              ...
                              className={`ud-menu-scroll flex items-center justify-between py-2 text-base text-dark group-hover:text-primary dark:text-black dark:group-hover:text-primary lg:inline-flex lg:px-0 lg:py-6`}
                            >
                              {menuItem.title}
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                {session?.user ? (
                  <button
                    onClick={() => signOut()}
                    className="signUpBtn bg-primary text-white px-3 py-1 rounded-lg lg:py-2 lg:px-4 md:px-3 md:py-1"
                  >
                    Sign Out
                  </button>
                ) : (
                  <>
                    <Link
                      href="/signin"
                      className="text-white lg:text-dark lg:bg-transparent lg:hover:text-primary px-3 py-1 md:px-3 md:py-1"
                    >
                      Sign In
                    </Link>
                    <Link
                      href="/signup"
                      className="bg-primary text-white px-3 py-1 rounded-lg hover:bg-primary/90 md:px-3 md:py-1"
                    >
                      Sign Up
                    </Link>
                  </>
