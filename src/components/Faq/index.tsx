    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          ...
          <SingleFaq
              question="How to use Crypto Build?"
              answer="Click the copy button and adjust your copy amount for maximum profit potential. It's recommended not to set a stop loss if you're aiming for the highest returns."
            />
            <SingleFaq
              question="How to manage my account?"
              answer="If you have USDT in your Binance account, it will automatically be managed by profitable algorithmic signals."
            />
            <SingleFaq
              question="How can I trust this strategy?"
              answer="You can track how this trading strategy performs on the market with mock trading. Once you're satisfied, you can invest your money."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What is the best investment amount?"
              answer="Consider your long-term growth goals for the next 3 years, and in the short term, evaluate how much risk you can handle. Be prepared for potential market fluctuations, including a drawdown of up to 40%."
            />
            <SingleFaq
              question="How does this business model work?"
              answer="We take a 10% fee from the profits made. This allows the business to grow sustainably and generate more profit for both us and investors."
            />
            <SingleFaq
              question="Is this safe?"
              answer="Investing can be challenging, but by leveraging advanced quantitative models and AI to fine-tune our strategies, we strive to make the investment process as secure and reliable as possible"
            />
          </div>
        </div>
      </div>
