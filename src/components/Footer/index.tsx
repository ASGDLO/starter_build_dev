...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-yellow-500 pt-20 lg:pt-[100px]" 
      data-wow-delay=".15s"
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-sm text-black">
                
              The resources and data disseminated by Crypto Build are strictly for pedagogical purposes and shall not be interpreted as financial advisement. Engaging in trading activities entails inherent risk, and historical performance should not be construed as indicative of future outcomes. The user assumes full and exclusive responsibility for any investment determinations executed via this platform. Crypto Build disclaims any and all liability for financial losses or detriments sustained. It is strongly advised that users consult with a duly certified financial consultant prior to initiating any investment activities.
              </p>
              <div className="-mx-3 flex items-center">
                <a
                  aria-label="social link"
                  href="/#"
                  className="px-3 text-black hover:text-black"
                >
                  <svg
                    width="22"
                    height="22"
                  ...
                  >
                    <path d="M23.498 6.186c-.273-1.03-1.08-1.837-2.11-2.11C19.8 3.5 12 3.5 12 3.5s-7.8 0-9.388.576c-1.03.273-1.837 1.08-2.11 2.11C0 7.774 0 12 0 12s0 4.226.502 5.814c.273 1.03 1.08 1.837 2.11 2.11C4.2 20.5 12 20.5 12 20.5s7.8 0 9.388-.576c1.03-.273 1.837-1.08 2.11-2.11C24 16.226 24 12 24 12s0-4.226-.502-5.814zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"/>
                  </svg>
                </a>
                <a
                  aria-label="social link"
                  href="https://x.com/trading7554"
                  className="px-3 text-black hover:text-black"
                >
                  <svg
                    width="22"
                ...
                <a
                  aria-label="social link"
                  href="https://www.instagram.com/cryptobuild_co/"
                  className="px-3 text-black hover:text-black"
                >
                  <svg
                    width="22"
                ...
                <a
                  aria-label="social link"
                  href="https://www.tiktok.com/@crypto_build_com"
                  className="px-3 text-black hover:text-black"
                >
                  <svg
                    width="22"
            ...
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <a
                    href="/#"
                    className="px-3 text-base text-black hover:text-black hover:underline"
                  >
                    Privacy policy
                  </a>
                  <a
